...
```{r, include = FALSE}
# dans Quarto, préciser un autre lien d'API pour que ça ne bug pas
...
Cette formation s'inspire, ainsi que son tutoriel, d'une [précédente formation](https://github.com/comeetie/satRday) donnée avec Etienne Côme et Timothée Giraud. 
